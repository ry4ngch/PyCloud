...
class Chat(ttk.Frame):
    def __init__(self, container=None, background=None, **kwargs):
    ...
    def get_messages(self):
        global messages
        #messages = requests.get("mock_message.json").json()
        json_file_path = os.path.join(os.path.dirname(__file__), 'mock_message.json')
